...
# Import Homebrew
from bitex.api.REST.rest import QryptosREST
from bitex.utils import return_api_response
from bitex.formatters.qryptos import QrptFormatter as fmt

# Init Logging Facilities
log = logging.getLogger(__name__)


class Qryptos(QryptosREST):
    def __init__(self, key='', secret='', key_file=''):
        super(Qryptos, self).__init__(key, secret)
        if key_file:
